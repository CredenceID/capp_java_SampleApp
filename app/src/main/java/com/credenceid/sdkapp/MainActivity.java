...
import static com.credenceid.biometrics.DeviceType.CredenceThreeR1_FC;
...
public class MainActivity extends AppCompatActivity {
  ...
  private static final String[] PERMISSIONS =
      new String[] {
        WRITE_EXTERNAL_STORAGE, READ_EXTERNAL_STORAGE, CAMERA, READ_CONTACTS, READ_PHONE_STATE
      };
  ...
  private void configureLayoutComponents() {
    ...
    mFingerprintButton.setOnClickListener(
        (View v) -> startActivity(new Intent(this, FingerprintActivity.class)));

    mCardReaderButton.setOnClickListener(
        (View v) -> startActivity(new Intent(this, CardReaderActivity.class)));

    mMRZButton.setOnClickListener((View v) -> startActivity(new Intent(this, MRZActivity.class)));
  ...
  private void initializeBiometrics() {
    ...
    App.BioManager.initializeBiometrics(
        (Biometrics.ResultCode resultCode, String sdk_version, String required_version) -> {
          if (OK == resultCode) {
  ...
  private void configureButtons(
      @SuppressWarnings("unused") DeviceFamily deviceFamily, DeviceType deviceType) {
   ...
   */
  private void setBiometricButtonsVisibility(
      @SuppressWarnings("SameParameterValue") int visibility) {
